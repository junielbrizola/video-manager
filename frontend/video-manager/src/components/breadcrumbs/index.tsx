...
import routes from '../../scenes/index.routes';
...
export default function Breadcrumbs() {
  ...
  function makeBreadcrumb(location: Location) {
    ...
    pathnames.unshift('/')
    return (
      <MuiBreadcrumbs className={classes.breadcrumbs} aria-label="breadcrumb">
        {
          pathnames.map((value, index) => {
            ...
            return last ? (
              ...
              <LinkRouter color="primary" to={to} key={to} className={classes.linkRouter}>
                {breadcrumbNameMap[route]}
              </LinkRouter>
            );
          })
